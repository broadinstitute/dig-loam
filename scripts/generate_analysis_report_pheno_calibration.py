...
def main(args=None):
	...
	with open(args.out_tex,'w') as f:
		...
		text.extend([
				r"   \caption{QQ plots for " + args.pheno_name.replace("_","\_") + r"}",
		...
		for a in mht_plots:
			...
			text.extend([
				...
				r"   \end{subfigure}" + delim])
		text.extend([
				r"   \caption{Manhattan plots for " + args.pheno_name.replace("_","\_") + r"}",
...
if __name__ == "__main__":
	...
	requiredArgs.add_argument('--qq-plots', help='a comma separated list of cohort labels, model names, and qq plots, each separated by 3 underscores', required=True)
	requiredArgs.add_argument('--mht-plots', help='a comma separated list of cohort labels, model names, and manhattan plots, each separated by 3 underscores', required=True)
