...
def main(args=None):
	...
	if not args.cloud:
		os.environ["PYSPARK_SUBMIT_ARGS"] = '--driver-memory ' + str(int(args.driver_memory)) + 'g --executor-memory ' + str(int(args.executor_memory)) + 'g pyspark-shell'
...
if __name__ == "__main__":
	...
	parser.add_argument('--driver-memory', type=double, default=1, help='spark driver memory in GB')
	parser.add_argument('--executor-memory', type=double, default=1, help='spark executor memory in GB')
