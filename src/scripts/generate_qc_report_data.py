	...
	with open(args.out,'w') as f:
		...
		with open(args.geno_variants_summary_table) as vsum:
			...
			if rows > 0:
				...
				text=r"Table \ref{table:genoVariantsSummaryTable} gives an overview of the different variant classes and how they distributed across allele frequencies in the raw data. Note that the totals reflect the sum of the chromosomes only. A legend has been provided below the table for further inspection of the class definitions."
				f.write("\n"); f.write(text.encode('utf-8')); f.write("\n")
