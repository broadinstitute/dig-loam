...
if __name__ == "__main__":
	...
	parser.add_argument('--sample-list', help='a sample list file')
	parser.add_argument('--variant-list', nargs='+', help='a list of array labels and variant list files, each separated by comma')
